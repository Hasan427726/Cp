...
class Eksekusi(Main):
	...
	def cek_opsi(self):
		...
		session.headers.update({
			...
			"user-agent":"Mozilla/5.0 (Linux; Android 11; M2007J20CG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.98 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]"
		})
